export interface SpaceWithAccessType {
  ...
  // ... other space properties from @w3ui/react Space interface
}
...
export interface FilteredSpaces {
  publicSpaces: any[] // Will be Space[] from @w3ui/react when available
  privateSpaces: any[] // Will be Space[] from @w3ui/react when available
